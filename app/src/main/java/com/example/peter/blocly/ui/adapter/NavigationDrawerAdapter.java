...
public class NavigationDrawerAdapter extends RecyclerView.Adapter<NavigationDrawerAdapter.ViewHolder> {
    ...
    public static interface Delegater {
        public void echoClick(NavigationDrawerAdapter adapter);
    }

    WeakReference<Delegater> delegate;

    public Delegater getDelegate() {
        if(delegate == null)
            return null;
        return delegate.get();
    }

    public void setDelegate(Delegater delegate) {
        this.delegate = new WeakReference<Delegater>(delegate);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            getDelegate().echoClick(NavigationDrawerAdapter.this);
        }
    }
}